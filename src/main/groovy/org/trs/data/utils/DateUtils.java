...
//		}
		if(unit.equals(TimeUnit.DAYS)){
			...
			for(int i=1;i<val+1;i++){
				buf.append((fmt.print(dt.plusDays(i)))+"|");
			}
			for(int i=1;i<val+1;i++){
				buf.append((fmt.print(dt.minusDays(i)))+"|");
			}
	...
	if(unit.equals(TimeUnit.MINUTES)){
			...
			for(int i=1;i<val+1;i++){
				buf.append((fmt.print(dt.plusMinutes(i)))+"|");
			}
			for(int i=1;i<val+1;i++){
				buf.append((fmt.print(dt1.minusMinutes(i)))+"|");
			}
